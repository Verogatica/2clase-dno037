...
function setup() {
    ...
    createA("florecita.html", "dibujo").parent("vinculos");
...
function portada() {
    createSpan(". sei in indice.html").parent("title");
    select("a:nth-child(1)").style("font-weight", "bold").style("color", "#3C1A60");
}
function pagina() {
    createSpan(". sei a pagina.html").parent("title");
    select("a:nth-child(2)").style("font-weight", "bold").style("color", "#3C1A60");
}